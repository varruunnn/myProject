export const projects = [
  ...
  {
    name: "Dodge Master",
    description: "A real-time multiplayer survival game where players dodge falling blocks and collect power-ups to outlast their opponents.",
    ...
    technologies: ["React", "Node.js", "Socket.IO", "Vite", "TailwindCSS", "Canvas API"],
    img: "/DodgeGame.png",
    color: "#a855f7",
